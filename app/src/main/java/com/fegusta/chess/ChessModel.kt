...
class ChessModel {
    ...
    fun reset() {
        ...
        pieceBox.add(ChessPiece(4,0,ChessPlayer.WHITE, ChessRank.KING, R.drawable.knight_white))
        pieceBox.add(ChessPiece(4,7,ChessPlayer.BLACK, ChessRank.KING, R.drawable.knight_black))
    }
